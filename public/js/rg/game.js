...
(function() {
  require.def(['rg/controls', 'rg/performance', 'rg/graphics', 'rg/player', 'rg/transition', 'rg/debug', 'toy2d/canvas'], (function(_this) {
    return function(Controls, Performance, Graphics, Player, Transition, Debug, Canvas) {
      ...
      return Game = (function() {
        ...
        Game.prototype.init_level = function() {
          this.stop();
          return require(["rg/level/" + this.level_number], (function(_this) {
