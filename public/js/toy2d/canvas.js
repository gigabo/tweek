...
(function() {
  require.def(['toy2d/debug', '/js/mustache.js'], (function(_this) {
    return function(Debug) {
      var Canvas, PI;
      PI = Math.PI;
      return Canvas = (function() {
        function Canvas(width, container) {
          this.width = width;
        ...
        Canvas.prototype.init_centered = function(draw_width) {
          var canvas, scale;
        ...
        Canvas.prototype.text_at = function(t, x, y, a) {
          a || (a = 0);
          return this.draw_at(x, y, a, (function(_this) {
            return function() {
              return _this.scale(0.01, 0.01, function() {
                _this.ctx.transform(1, 0, 0, -1, 0, 0);
                return _this.ctx.fillText(t, 0, 0);
              });
            };
          })(this));
        };
        ...
        Canvas.prototype.ellipse = function(a, b) {
          var i, step_arc, steps, theta, x, y, _i, _results;
          steps = 90;
          step_arc = 2 * PI / steps;
          this.ctx.moveTo(a, 0);
          _results = [];
