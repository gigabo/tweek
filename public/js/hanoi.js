(function() {
  var Disk, HEIGHT, MAX_HEIGHT, Tower, WIDTH, canvas, clear, ctx, draw, get_move, init, init_canvas, init_controls, init_towers, initial_ratio, move_number, re_init_towers, rect, step, step_timer, tower_height, towers, update_canvas_width;
