(function() {
  ...
  _.without = function(array) {
    var _a, _b, _c, _d, val, values;
    values = _.rest(arguments);
    _a = []; _c = _.toArray(array);
    for (_b = 0, _d = _c.length; _b < _d; _b++) {
      val = _c[_b];
  ...
  _.compose = function() {
    ...
    return function() {
      ...
      args = arguments;
      _a = (funcs.length - 1);
      for (i = _a; (_a <= 0 ? i <= 0 : i >= 0); (_a <= 0 ? i += 1 : i -= 1)) {
  ...
  _.isEqual = function(a, b) {
    var _a, aKeys, atype, bKeys, btype, key, val;
    if (a === b) {
      return true;
    }
    atype = typeof (a);
  ...
  _.times = function(n, iterator, context) {
    ...
    for (i = 0; (0 <= n ? i < n : i > n); (0 <= n ? i += 1 : i -= 1)) {
      _a.push(iterator.call(context, i));
    }
    return _a;
  };
  ...
  _.mixin = function(obj) {
    ...
    _a = []; _c = _.functions(obj);
    for (_b = 0, _d = _c.length; _b < _d; _b++) {
      name = _c[_b];
      _a.push(addToWrapper(name, _[name] = obj[name]));
    }
    return _a;
  };
  idCounter = 0;
