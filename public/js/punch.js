(function() {
  var Halo, api_go, canvas, circle, clear, ctx, dates, draw, draw_halos, draw_punchcard, frame, grid, halo_life, halos, height, init, init_handle_input, initial_ratio, max_encountered, new_halo, step, step_counter, update_canvas_width, user, width;
