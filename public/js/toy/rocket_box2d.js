...
(function() {
  require.def(['toy2d/debug', 'toy2d/canvas', 'toy2d/canvas_scale', 'toy2d/controls', '/js/box2d.js'], (function(_this) {
    return function(Debug, Canvas, CanvasScale, Controls) {
      ...
      Trail = (function() {
        ...
        Trail.prototype.draw = function(graphics) {
          var body, ctx, div, i, mult, t, tff, _i, _len, _ref, _results;
          ctx = graphics.ctx;
          ctx.fillStyle = 'black';
          i = 0;
          _ref = this.sparks;
      ...
      return Toy = (function() {
        ...
        Toy.prototype.start = function() {
          if (!this.running) {
            this.main_interval = setInterval((function(_this) {
              return function() {
                return _this.step();
              };
            })(this), 20);
        ...
        Toy.prototype.draw_bodies = function() {
          var body, t, _i, _len, _ref, _results;
          ...
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            ...
            this.ctx.rotate(-body.GetAngle());
            _results.push(this.ctx.translate(-t.position.x, -t.position.y));
          }
          return _results;
        };
